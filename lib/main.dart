      ...
      appBar: AppBar(
        title: const Column(
          ...
          children: [
            ...
            Text('د عزيزي ترانې', style: TextStyle(fontSize: 13)),
          ],
        ),
      ),
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: items.isEmpty
                  ? const Center(child: Text('کومه ترانه ونه موندل شوه'))
                  : ListView.separated(
                ...
                builder: (context, posSnap) {
                  ...
                  return Material(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text(tarany[_currentIndex!].title, textDirection: TextDirection.rtl, maxLines: 1, overflow: TextOverflow.ellipsis),
                          Slider(
                            min: 0,
                            max: maxMs,
                            value: value,
